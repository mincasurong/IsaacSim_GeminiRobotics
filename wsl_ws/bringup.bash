...
echo -e "${CYAN}=================================================================${NC}"
echo -e "  ${BOLD}1)${NC} [Gemini]  Start 3-Arm Tower VLM Orchestrator ${GREEN}(For Isaac Option 1-3)${NC}"
echo -e "  ${BOLD}2)${NC} [Manual]  Start 3-Arm Rule-Based Stacker"
...
echo -e "  ${BOLD}7)${NC} [Gemini]  Start Dual FR3 Conveyor Controller ${GREEN}(For Isaac Option 5)${NC}"
echo -e "  ${BOLD}8)${NC} [Gemini]  Start Long-Horizon Assembly Controller ${GREEN}(For Isaac Option 6)${NC}"
echo -e "${CYAN}=================================================================${NC}"
echo ""
echo -en "${GREEN}Enter your choice [1-8, default: 4] > ${NC}"
read OPTION
